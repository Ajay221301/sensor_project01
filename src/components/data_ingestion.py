...
class DataIngestion:
    ...
    def export_collection_as_dataframe(self, collection_name, db_name):
        ...
        try:
            ...
            # Drop MongoDB '_id' and 'Wafer' columns if present
            cols_to_drop = [col for col in ["_id", "Wafer_num"] if col in df.columns.to_list()]
            if cols_to_drop:
    ...
    def initiate_data_ingestion(self) -> Path:
        logging.info("Entered initiated_dat_ingestion method of data_integration class")
